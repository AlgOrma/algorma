  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Inline Error Banner */}
        {errorMessage && (
          <div role="alert" className="px-5 py-2 bg-badge-hard-bg border-b border-badge-hard-border text-accent-red-text text-fs-11 font-mono flex items-center gap-2">
